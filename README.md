...
## Acknowledgment
This project was built using the guide provided by Coddy.tech. The original project can be found **[here](https://coddy.tech/courses/slider__frontend_project)**.
